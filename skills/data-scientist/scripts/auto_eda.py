...
class AutoEDA:
    ...
    def analyze_data_quality(self):
        ...
        missing_df = pd.DataFrame({"Missing_Count": missing, "Missing_Percentage": missing_pct}).sort_values(
    ...
    def analyze_categorical(self):
        ...
        for col in cat_cols:
            ...
            if n_unique <= 20:
                ...
                self._add_to_report("  Top categories:")
                ...
                self._add_to_report("  High cardinality - showing top 5 only")
                value_counts = self.df[col].value_counts()
    ...
    def analyze_target(self):
        ...
        if pd.api.types.is_numeric_dtype(target):
            ...
            if num_cols:
                ...
                correlations.head(20).plot(
                    kind="barh", color=["green" if x > 0 else "red" for x in correlations.head(20)]
                )
