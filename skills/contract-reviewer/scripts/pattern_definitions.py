...
RED_FLAG_PATTERNS = [
    ...
    },
    {
        ...
        "pattern": r"(customer|licensee|buyer)\s+shall\s+indemnif.{0,100}(?!.{0,200}(vendor|provider|licensor|seller)\s+shall\s+indemnif)",
        "severity": "Critical",
        "category": "Financial",
    ...
    },
    {
        ...
        "pattern": r"(automatically\s+renew|auto[\-\s]?renew).{0,200}(notice|prior).{0,50}(9[0-9]|1[0-9]{2}|[2-9][0-9]{2})\s*days?",
        "severity": "High",
    ...
    },
    {
        ...
        "pattern": r"(?<!no )(?<!excluded )(?<!excludes )consequential\s+damages?(?!\s+(?:excluded?|waive[sd]?|shall\s+not))",
        "severity": "High",
        "category": "Financial",
    ...
    },
    {
        ...
        "pattern": r"(?<!may )(?<!right to )terminat.{0,30}(for\s+convenience|without\s+cause|at\s+will)",
        "severity": "High",
        "category": "Operational",
