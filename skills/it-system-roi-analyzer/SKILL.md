...
```bash
python scripts/it_roi_calculator.py --investment 50000000 --annual-benefit 15000000 --years 5 --rate 0.10
```

### JSON入力での詳細計算

```bash
python scripts/it_roi_calculator.py --input project_data.json --output report.md
```
