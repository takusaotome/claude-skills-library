...
5. Update README.md: increment skill count in Repository Structure and Skill Catalog headings, add entry to the category table AND increment that category's skill count (e.g. "Software Development & IT (N skills)"), add to Available Skills (Detailed) section, add Version History entry
6. SKILL.md must start with YAML frontmatter (--- delimited), title after frontmatter
7. Do NOT duplicate functionality of existing skills listed below
8. Use imperative verb forms in SKILL.md workflow steps
9. All scripts must use relative paths (no hardcoded absolute paths)
