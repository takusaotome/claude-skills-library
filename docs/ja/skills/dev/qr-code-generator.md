...
parent: ソフトウェア開発
nav_order: 24
lang_peer: /en/skills/dev/qr-code-generator/
permalink: /ja/skills/dev/qr-code-generator/
---

# QR Code Generator
{: .no_toc }

QR Code Generator に関する日本語ガイドです。`skills/qr-code-generator/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/qr-code-generator.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/qr-code-generator){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **QR Code Generator** スキルの日本語サマリーです。
- スキル本体: `skills/qr-code-generator/SKILL.md`
- 参照ガイド: 1 件
- 補助スクリプト: 1 件
...
- APIキーは不要です
- Python 3.9 以上を推奨します
- 主な依存パッケージ: qrcode[pil] (includes Pillow for PNG output)
...
1. `skills/qr-code-generator/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **QR Code Generator** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/qr-code-generator/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/dev/qr-code-generator/' | relative_url }}) を参照してください。
