...
parent: ソフトウェア開発
nav_order: 22
lang_peer: /en/skills/dev/network-diagnostics/
permalink: /ja/skills/dev/network-diagnostics/
---

# Network Diagnostics
{: .no_toc }

Network Diagnostics に関する日本語ガイドです。`skills/network-diagnostics/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/network-diagnostics.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/network-diagnostics){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Network Diagnostics** スキルの日本語サマリーです。
- スキル本体: `skills/network-diagnostics/SKILL.md`
- 参照ガイド: 2 件
- 補助スクリプト: 1 件
...
1. `skills/network-diagnostics/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Network Diagnostics** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/network-diagnostics/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/dev/network-diagnostics/' | relative_url }}) を参照してください。
