...
parent: 財務・分析
nav_order: 10
lang_peer: /en/skills/finance/lean-six-sigma-consultant/
permalink: /ja/skills/finance/lean-six-sigma-consultant/
---

# Lean Six Sigma Consultant
{: .no_toc }

Lean Six Sigma Consultant に関する日本語ガイドです。`skills/lean-six-sigma-consultant/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/lean-six-sigma-consultant.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/lean-six-sigma-consultant){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Lean Six Sigma Consultant** スキルの日本語サマリーです。
- スキル本体: `skills/lean-six-sigma-consultant/SKILL.md`
- 参照ガイド: 1 件
- 補助スクリプト: 3 件
...
1. `skills/lean-six-sigma-consultant/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Lean Six Sigma Consultant** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/lean-six-sigma-consultant/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/finance/lean-six-sigma-consultant/' | relative_url }}) を参照してください。
