...
parent: 財務・分析
nav_order: 2
lang_peer: /en/skills/finance/audit-control-designer/
permalink: /ja/skills/finance/audit-control-designer/
---

# Audit Control Designer
{: .no_toc }

Audit Control Designer に関する日本語ガイドです。`skills/audit-control-designer/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/audit-control-designer.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/audit-control-designer){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Audit Control Designer** スキルの日本語サマリーです。
- スキル本体: `skills/audit-control-designer/SKILL.md`
- 参照ガイド: 7 件
- 補助スクリプト: なし
...
1. `skills/audit-control-designer/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Audit Control Designer** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/audit-control-designer/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/finance/audit-control-designer/' | relative_url }}) を参照してください。
