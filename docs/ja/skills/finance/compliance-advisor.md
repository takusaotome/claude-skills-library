...
parent: 財務・分析
nav_order: 4
lang_peer: /en/skills/finance/compliance-advisor/
permalink: /ja/skills/finance/compliance-advisor/
---

# Compliance Advisor
{: .no_toc }

Compliance Advisor に関する日本語ガイドです。`skills/compliance-advisor/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/compliance-advisor.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/compliance-advisor){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Compliance Advisor** スキルの日本語サマリーです。
- スキル本体: `skills/compliance-advisor/SKILL.md`
- 参照ガイド: 3 件
- 補助スクリプト: なし
...
1. `skills/compliance-advisor/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Compliance Advisor** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/compliance-advisor/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/finance/compliance-advisor/' | relative_url }}) を参照してください。
