...
Dama Dmbok に関する日本語ガイドです。`skills/dama-dmbok/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }
...
このページは **Dama Dmbok** スキルの日本語サマリーです。
- スキル本体: `skills/dama-dmbok/SKILL.md`
- 参照ガイド: 6 件
- 補助スクリプト: なし
...
1. `skills/dama-dmbok/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- 詳細な手順や判断基準は `skills/dama-dmbok/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/finance/dama-dmbok/' | relative_url }}) を参照してください。
