...
parent: 財務・分析
nav_order: 15
lang_peer: /en/skills/finance/pci-dss-compliance-consultant/
permalink: /ja/skills/finance/pci-dss-compliance-consultant/
---

# PCI DSS Compliance Consultant
{: .no_toc }

PCI DSS Compliance Consultant に関する日本語ガイドです。`skills/pci-dss-compliance-consultant/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/pci-dss-compliance-consultant.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/pci-dss-compliance-consultant){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **PCI DSS Compliance Consultant** スキルの日本語サマリーです。
- スキル本体: `skills/pci-dss-compliance-consultant/SKILL.md`
- 参照ガイド: 6 件
- 補助スクリプト: なし
...
1. `skills/pci-dss-compliance-consultant/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **PCI DSS Compliance Consultant** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/pci-dss-compliance-consultant/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/finance/pci-dss-compliance-consultant/' | relative_url }}) を参照してください。
