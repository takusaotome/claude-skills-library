...
parent: プロジェクト・経営
nav_order: 28
lang_peer: /en/skills/management/wbs-review-assistant/
permalink: /ja/skills/management/wbs-review-assistant/
---

# WBS Review Assistant
{: .no_toc }

WBS Review Assistant に関する日本語ガイドです。`skills/wbs-review-assistant/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/wbs-review-assistant.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/wbs-review-assistant){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **WBS Review Assistant** スキルの日本語サマリーです。
- スキル本体: `skills/wbs-review-assistant/SKILL.md`
- 参照ガイド: 3 件
- 補助スクリプト: 3 件
...
- APIキーは不要です
- Python 3.9 以上を推奨します
- 主な依存パッケージ: openpyxl, pandas, pyyaml
...
1. `skills/wbs-review-assistant/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **WBS Review Assistant** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/wbs-review-assistant/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/management/wbs-review-assistant/' | relative_url }}) を参照してください。
