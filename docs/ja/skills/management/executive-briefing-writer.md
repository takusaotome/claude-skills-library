...
parent: プロジェクト・経営
nav_order: 12
lang_peer: /en/skills/management/executive-briefing-writer/
permalink: /ja/skills/management/executive-briefing-writer/
---

# Executive Briefing Writer
{: .no_toc }

Executive Briefing Writer に関する日本語ガイドです。`skills/executive-briefing-writer/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/executive-briefing-writer.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/executive-briefing-writer){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Executive Briefing Writer** スキルの日本語サマリーです。
- スキル本体: `skills/executive-briefing-writer/SKILL.md`
- 参照ガイド: 4 件
- 補助スクリプト: なし
...
1. `skills/executive-briefing-writer/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Executive Briefing Writer** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/executive-briefing-writer/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/management/executive-briefing-writer/' | relative_url }}) を参照してください。
