...
parent: プロジェクト・経営
nav_order: 25
lang_peer: /en/skills/management/uat-testcase-generator/
permalink: /ja/skills/management/uat-testcase-generator/
---

# UAT Testcase Generator
{: .no_toc }

UAT Testcase Generator に関する日本語ガイドです。`skills/uat-testcase-generator/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/uat-testcase-generator.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/uat-testcase-generator){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **UAT Testcase Generator** スキルの日本語サマリーです。
- スキル本体: `skills/uat-testcase-generator/SKILL.md`
- 参照ガイド: 1 件
- 補助スクリプト: 1 件
...
1. `skills/uat-testcase-generator/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **UAT Testcase Generator** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/uat-testcase-generator/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/management/uat-testcase-generator/' | relative_url }}) を参照してください。
