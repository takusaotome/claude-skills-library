...
parent: プロジェクト・経営
nav_order: 19
lang_peer: /en/skills/management/project-artifact-linker/
permalink: /ja/skills/management/project-artifact-linker/
---

# Project Artifact Linker
{: .no_toc }

Project Artifact Linker に関する日本語ガイドです。`skills/project-artifact-linker/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/project-artifact-linker.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/project-artifact-linker){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Project Artifact Linker** スキルの日本語サマリーです。
- スキル本体: `skills/project-artifact-linker/SKILL.md`
- 参照ガイド: 2 件
- 補助スクリプト: 4 件
...
- APIキーは不要です
- Python 3.9 以上を推奨します
- 主な依存パッケージ: pyyaml (for YAML parsing), standard library otherwise
...
1. `skills/project-artifact-linker/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Project Artifact Linker** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/project-artifact-linker/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/management/project-artifact-linker/' | relative_url }}) を参照してください。
