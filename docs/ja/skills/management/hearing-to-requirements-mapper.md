...
parent: プロジェクト・経営
nav_order: 13
lang_peer: /en/skills/management/hearing-to-requirements-mapper/
permalink: /ja/skills/management/hearing-to-requirements-mapper/
---

# Hearing To Requirements Mapper
{: .no_toc }

Hearing To Requirements Mapper に関する日本語ガイドです。`skills/hearing-to-requirements-mapper/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/hearing-to-requirements-mapper.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/hearing-to-requirements-mapper){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Hearing To Requirements Mapper** スキルの日本語サマリーです。
- スキル本体: `skills/hearing-to-requirements-mapper/SKILL.md`
- 参照ガイド: 4 件
- 補助スクリプト: 1 件
...
- APIキーは不要です
- Python 3.9 以上を推奨します
- 主な依存パッケージ: pandas, openpyxl (for Excel output)
...
1. `skills/hearing-to-requirements-mapper/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Hearing To Requirements Mapper** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/hearing-to-requirements-mapper/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/management/hearing-to-requirements-mapper/' | relative_url }}) を参照してください。
