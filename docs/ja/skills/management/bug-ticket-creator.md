...
parent: プロジェクト・経営
nav_order: 6
lang_peer: /en/skills/management/bug-ticket-creator/
permalink: /ja/skills/management/bug-ticket-creator/
---

# Bug Ticket Creator
{: .no_toc }

Bug Ticket Creator に関する日本語ガイドです。`skills/bug-ticket-creator/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/bug-ticket-creator.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/bug-ticket-creator){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **Bug Ticket Creator** スキルの日本語サマリーです。
- スキル本体: `skills/bug-ticket-creator/SKILL.md`
- 参照ガイド: 3 件
- 補助スクリプト: なし
...
1. `skills/bug-ticket-creator/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **Bug Ticket Creator** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/bug-ticket-creator/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/management/bug-ticket-creator/' | relative_url }}) を参照してください。
