...
AI Text Humanizer に関する日本語ガイドです。`skills/ai-text-humanizer/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }
...
このページは **AI Text Humanizer** スキルの日本語サマリーです。
- スキル本体: `skills/ai-text-humanizer/SKILL.md`
- 参照ガイド: 3 件
- 補助スクリプト: 1 件
...
1. `skills/ai-text-humanizer/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **AI Text Humanizer** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/ai-text-humanizer/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/ops/ai-text-humanizer/' | relative_url }}) を参照してください。
