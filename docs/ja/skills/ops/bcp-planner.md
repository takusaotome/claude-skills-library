...
parent: 運用・ドキュメント
nav_order: 5
lang_peer: /en/skills/ops/bcp-planner/
permalink: /ja/skills/ops/bcp-planner/
---

# BCP Planner
{: .no_toc }

BCP Planner に関する日本語ガイドです。`skills/bcp-planner/SKILL.md` をもとに、利用開始手順、参照ファイル、補助スクリプトへの入口を日本語で整理しています。
{: .fs-6 .fw-300 }

<span class="badge badge-free">API不要</span>

[スキルパッケージをダウンロード (.skill)](https://github.com/takusaotome/claude-skills-library/raw/main/skill-packages/bcp-planner.skill){: .btn .btn-primary .fs-5 .mb-4 .mb-md-0 .mr-2 }
[GitHubでソースを見る](https://github.com/takusaotome/claude-skills-library/tree/main/skills/bcp-planner){: .btn .fs-5 .mb-4 .mb-md-0 }
...
このページは **BCP Planner** スキルの日本語サマリーです。
- スキル本体: `skills/bcp-planner/SKILL.md`
- 参照ガイド: なし
- 補助スクリプト: なし
...
1. `skills/bcp-planner/SKILL.md` を開き、対象タスクと期待する成果物を確認します。
...
- **BCP Planner** に沿って作業の進め方を整理したいとき
...
- 詳細な手順や判断基準は `skills/bcp-planner/SKILL.md` を基準にしてください。
...
- 詳細な解説、背景説明、個別の運用判断は [English version]({{ '/en/skills/ops/bcp-planner/' | relative_url }}) を参照してください。
